...
/**
 * @title Finance's CErc20Delegator Contract
...
contract CErc20Delegator is CTokenInterface, CErc20Interface, CDelegatorInterface {
    ...
    function _setFinancetroller(FinancetrollerInterface newFinancetroller) override public returns (uint) {
        bytes memory data = delegateToImplementation(abi.encodeWithSignature("_setFinancetroller(address)", newFinancetroller));
        return abi.decode(data, (uint));
    }
